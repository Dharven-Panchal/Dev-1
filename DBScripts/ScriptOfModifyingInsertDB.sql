USE [DataCrawling]
GO
/****** Object:  StoredProcedure [dbo].[sp_InsertCaseRecord]    Script Date: 08-09-2021 09:59:44 ******/
SET ANSI_NULLS ON
GO
	...
	begin
		...
		begin 
			...
			--select '1'
			   ...
			   select Fname,Mname,Lname,Address1,Address2,State,City,ZipCode,CaseNumber,CaseType,CaseDate,PartyName,GETDATE(),NewBalance,BusinessName,cast(CONVERT(nvarchar(50), DateFrom, 101) as date), cast(CONVERT(nvarchar(50), DateTo, 101) as date) --,CONVERT(SMALLDATETIME, DateFrom,105),CONVERT(SMALLDATETIME, DateTo,105) 
			   from #CaseData_t
			   set @Errorcode  =@@ERROR
			end
		End
